...
$ ./uidsubmit -i 10.46.48.100 -p 25555 -b 200 -s 192.168.10.1 -e 192.168.12.20 -d pantac \n"""
	...
	parser.add_argument("-d", "--DOMAIN", help="Domain prefix, default = pantac", default='pantac')
